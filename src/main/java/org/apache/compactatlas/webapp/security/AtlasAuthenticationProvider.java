...
public class AtlasAuthenticationProvider extends AtlasAbstractAuthenticationProvider {
    ...
    private boolean fileAuthenticationMethodEnabled = false;
    ...
    public AtlasAuthenticationProvider(AtlasLdapAuthenticationProvider ldapAuthenticationProvider,
                                       ...
                                       AtlasPamAuthenticationProvider pamAuthenticationProviderr) {
        ...
        this.pamAuthenticationProvider = pamAuthenticationProviderr;
    ...
    void setAuthenticationMethod() {
        try {
            ...
            this.fileAuthenticationMethodEnabled = configuration.getBoolean(FILE_AUTH_METHOD, false);
