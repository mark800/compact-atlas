...
import org.apache.compactatlas.intg.v1.model.lineage.DataSetLineageResponse;
...
import static org.apache.compactatlas.intg.v1.model.lineage.SchemaResponse.SchemaDetails;

/**
 * Jersey Resource for Hive Table Lineage.
 */
@RequestMapping("api/lineage/hive")
@RestController
public class DataSetLineageResource {
     ...
     */
    @GetMapping("table/{tableName}/inputs/graph")
    @Consumes(Servlets.JSON_MEDIA_TYPE)
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public DataSetLineageResponse inputsGraph(@Context HttpServletRequest request,@PathVariable String tableName) {
     ...
     * @param tableName table name
     */
    @GetMapping("table/{tableName}/outputs/graph")
    @Consumes(Servlets.JSON_MEDIA_TYPE)
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public DataSetLineageResponse outputsGraph(@Context HttpServletRequest request, @PathVariable String tableName) {
        if (LOG.isDebugEnabled()) {
    ...
    @Consumes(Servlets.JSON_MEDIA_TYPE)
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public SchemaResponse schema(@Context HttpServletRequest request, @PathVariable String tableName) {
        if (LOG.isDebugEnabled()) {
