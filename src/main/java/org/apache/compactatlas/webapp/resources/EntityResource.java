...
import org.apache.compactatlas.client.CreateUpdateEntitiesResult;
import org.apache.compactatlas.client.EntityAuditEvent;
import org.apache.compactatlas.common.AtlasConstants;
...
import org.apache.compactatlas.intg.model.instance.GuidMapping;
import org.apache.compactatlas.intg.model.legacy.EntityResult;
...
import org.apache.compactatlas.intg.v1.model.instance.Id;
import org.apache.compactatlas.intg.v1.model.instance.Referenceable;
import org.apache.compactatlas.intg.v1.model.instance.Struct;
import org.apache.compactatlas.webapp.rest.EntityREST;
...
public class EntityResource {
    ...
    private final InMemoryEntityAuditRepository  entityAuditRepository;
    ...
    public EntityResource(final AtlasInstanceConverter restAdapters,
                          ...
                          final InMemoryEntityAuditRepository entityAuditRepository,
     ...
     * unique attribute for the give type.
     */
    @PostMapping("qualifiedName")
    @Consumes({Servlets.JSON_MEDIA_TYPE, MediaType.APPLICATION_JSON})
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response updateByUniqueAttribute(@RequestParam("type") String entityType,
                                            @RequestParam("property") String attribute,
                                            @RequestParam("value") String value, @Context HttpServletRequest request) {
        if (LOG.isDebugEnabled()) {
    ...
    @Consumes({Servlets.JSON_MEDIA_TYPE, MediaType.APPLICATION_JSON})
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response updateEntityByGuid(@PathVariable String guid, @RequestParam("property") String attribute,
    ...
    @DELETE
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response deleteEntities(@RequestParam("guid") List<String> guids,
                                   @RequestParam("type") String entityType,
                                   @RequestParam("property") final String attribute,
    ...
    @GetMapping("{guid}")
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getEntityDefinition(@PathVariable String guid) {
        if (LOG.isDebugEnabled()) {
    ...
    @Consumes({Servlets.JSON_MEDIA_TYPE, MediaType.APPLICATION_JSON})
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getEntity(@RequestParam("type") String entityType,
                              @RequestParam("property") String attribute,
                              @RequestParam("value") final String value) {
        if (LOG.isDebugEnabled()) {
     ...
     */
    @GetMapping("{guid}/traits")
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getTraitNames(@PathVariable String guid) {
        if (LOG.isDebugEnabled()) {
     ...
     * @param guid globally unique identifier for the entity
     */
    @GetMapping("{guid}/traitDefinitions")
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getTraitDefinitionsForEntity(@PathVariable String guid){
        if (LOG.isDebugEnabled()) {
     ...
     */
    @GetMapping("{guid}/traitDefinitions/{traitName}")
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getTraitDefinitionForEntity(@PathVariable String guid, @PathVariable String traitName){
        if (LOG.isDebugEnabled()) {
     ...
     * @param guid globally unique identifier for the entity
     */
    @PostMapping("{guid}/traits")
    @Consumes({Servlets.JSON_MEDIA_TYPE, MediaType.APPLICATION_JSON})
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response addTrait(@Context HttpServletRequest request, @PathVariable String guid) {
        if (LOG.isDebugEnabled()) {
     ...
     * @param traitName name of the trait
     */
    @DeleteMapping("{guid}/traits/{traitName}")
    @Consumes({Servlets.JSON_MEDIA_TYPE, MediaType.APPLICATION_JSON})
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response deleteTrait(@Context HttpServletRequest request, @PathVariable String guid,
            @RequestParam(TRAIT_NAME) final String traitName) {
        if (LOG.isDebugEnabled()) {
    ...
    @Produces(Servlets.JSON_MEDIA_TYPE)
    public Response getAuditEvents(@PathVariable String guid, @RequestParam("startKey") String startKey,
                                   @RequestParam(defaultValue = "100") short count) {
        if (LOG.isDebugEnabled()) {
