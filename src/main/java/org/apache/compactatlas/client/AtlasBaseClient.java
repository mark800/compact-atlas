 ...
 */
package org.apache.compactatlas.client;
...
import org.apache.compactatlas.client.common.AtlasServerEnsemble;
import org.apache.compactatlas.client.common.AtlasServiceException;
import org.apache.compactatlas.client.common.ResourceCreator;
...
import org.apache.compactatlas.intg.utils.AuthenticationUtil;
...
import static org.apache.compactatlas.intg.security.SecurityProperties.TLS_ENABLED;
...
public abstract class AtlasBaseClient {
    ...
    protected AtlasBaseClient(String[] baseUrl, String[] basicAuthUserNamePassword) {
        ...
        initializeState(baseUrl, this.basicAuthUser);
    }

    protected AtlasBaseClient(String[] baseUrl, String[] basicAuthUserNamePassword, String doAsUser) {
        if (basicAuthUserNamePassword != null) {
            if (basicAuthUserNamePassword.length > 0) {
                this.basicAuthUser = basicAuthUserNamePassword[0];
            }
    ...
    protected Client getClient(Configuration configuration, String ugi, String doAsUser) {
...
//        }
    ...
    void initializeState(String[] baseUrls, String doAsUser) {
        initializeState(getClientProperties(), baseUrls, null, doAsUser);
    }

    void initializeState(Configuration configuration, String[] baseUrls, String ugi, String doAsUser) {
        this.configuration = configuration;
    ...
    void handleClientHandlerException(ClientHandlerException che) {
        if (isRetryableException(che)) {
            ...
            sleepBetweenRetries();
            initializeState(atlasClientContext.getBaseUrls(),
    ...
    private class AtlasClientContext {
        ...
        public AtlasClientContext(String[] baseUrls, Client client, String ugi, String doAsUser) {
