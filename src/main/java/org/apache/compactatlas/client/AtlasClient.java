...
import org.apache.compactatlas.intg.v1.typesystem.types.utils.TypesUtil;
...
public class AtlasClient extends AtlasBaseClient {
    ...
    public AtlasClient(String doAsUser, String... baseUrls) {
        initializeState(baseUrls, doAsUser);
    }
...
//    }
    ...
    public AtlasClient(Configuration configuration, String... baseUrls) throws AtlasException {
        initializeState(configuration, baseUrls, null, null);
    }
     ...
     * @throws AtlasServiceException
     */
    public List<String> listTypes(final BaseDataTypes.TypeCategory category) throws AtlasServiceException {
     ...
     * @return list of type names
     */
    public List<String> listTypes(final BaseDataTypes.TypeCategory category, final String superType,
