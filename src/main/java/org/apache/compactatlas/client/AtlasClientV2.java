...
import org.apache.compactatlas.intg.model.instance.AtlasClassification.AtlasClassifications;
...
public class AtlasClientV2 extends AtlasBaseClient {
    ...
    public AtlasClientV2(String[] baseUrl, String[] basicAuthUserNamePassword, String doAsUser) {
        super(baseUrl, basicAuthUserNamePassword, doAsUser);
    }
...
//    }
    ...
    public void updateClassification(String guid, AtlasClassification classification) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.UPDATE_CLASSIFICATION, guid), (Class<?>)null, classification);
    }
    ...
    public static class API_V2 extends API {
        ...
        public static final API_V2 UPDATE_CLASSIFICATION                      = new API_V2(ENTITY_API + "guid/%s/classification", HttpMethod.POST, Response.Status.NO_CONTENT);
