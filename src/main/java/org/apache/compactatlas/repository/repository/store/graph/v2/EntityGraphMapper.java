...
import org.apache.compactatlas.repository.GraphTransactionInterceptor;
...
import org.apache.compactatlas.intg.exception.AtlasBaseException;
 import org.apache.compactatlas.serverapi.exception.EntityNotFoundException;
 import org.apache.compactatlas.intg.model.TimeBoundary;
...
import org.apache.compactatlas.intg.model.instance.AtlasStruct;
import org.apache.compactatlas.intg.model.instance.EntityMutationResponse;
import org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation;
import org.apache.compactatlas.intg.model.typedef.AtlasEntityDef;
import org.apache.compactatlas.intg.model.typedef.AtlasEntityDef.AtlasRelationshipAttributeDef;
import org.apache.compactatlas.intg.model.typedef.AtlasStructDef.AtlasAttributeDef;
import org.apache.compactatlas.intg.model.typedef.AtlasStructDef.AtlasAttributeDef.Cardinality;
import org.apache.compactatlas.common.repository.Constants;
import org.apache.compactatlas.repository.repository.RepositoryException;
import org.apache.compactatlas.repository.repository.converters.AtlasInstanceConverter;
import org.apache.compactatlas.repository.repository.graph.GraphHelper;
import org.apache.compactatlas.repository.repository.graph.IFullTextMapper;
...
import org.apache.compactatlas.repository.repository.store.graph.v1.DeleteHandlerDelegate;
 import org.apache.compactatlas.repository.tasks.TaskManagement;
 import org.apache.compactatlas.intg.type.AtlasArrayType;
import org.apache.compactatlas.intg.type.AtlasBuiltInTypes;
import org.apache.compactatlas.intg.type.AtlasBusinessMetadataType.AtlasBusinessAttribute;
...
import org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute;
import org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute.AtlasRelationshipEdgeDirection;
...
import org.apache.compactatlas.intg.utils.AtlasEntityUtil;
import org.apache.compactatlas.intg.utils.AtlasJson;
import org.apache.compactatlas.common.utils.AtlasPerfMetrics.MetricRecorder;
import org.apache.compactatlas.common.utils.AtlasPerfTracer;
 import org.apache.compactatlas.repository.repository.store.graph.v2.tasks.ClassificationPropagateTaskFactory;
...
import static org.apache.compactatlas.intg.AtlasConfiguration.LABEL_MAX_LENGTH;
import static org.apache.compactatlas.intg.model.TypeCategory.CLASSIFICATION;
import static org.apache.compactatlas.intg.model.instance.AtlasEntity.Status.ACTIVE;
import static org.apache.compactatlas.intg.model.instance.AtlasEntity.Status.DELETED;
import static org.apache.compactatlas.intg.model.instance.AtlasRelatedObjectId.KEY_RELATIONSHIP_ATTRIBUTES;
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.CREATE;
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.DELETE;
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.PARTIAL_UPDATE;
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.UPDATE;
import static org.apache.compactatlas.intg.model.typedef.AtlasStructDef.AtlasAttributeDef.Cardinality.SET;
import static org.apache.compactatlas.common.repository.Constants.*;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getClassificationEdge;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getClassificationVertex;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getCollectionElementsUsingRelationship;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getDelimitedClassificationNames;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getLabels;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getMapElementsProperty;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getStatus;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getTraitLabel;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getTraitNames;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getTypeName;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getTypeNames;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.isActive;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.isPropagationEnabled;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.isRelationshipEdge;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.string;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.updateModificationMetadata;
 import static org.apache.compactatlas.repository.repository.store.graph.v2.AtlasGraphUtilsV2.isReference;
 import static org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute.AtlasRelationshipEdgeDirection.IN;
import static org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute.AtlasRelationshipEdgeDirection.OUT;
import static org.apache.compactatlas.intg.type.Constants.PENDING_TASKS_PROPERTY_KEY;
...
public class EntityGraphMapper {
    ...
    private AtlasEdge getEdgeAt(List<Object> currentElements, int index, AtlasType elemType) {
        ...
        if (AtlasGraphUtilsV2.isReference(elemType)) {
    ...
    private List<AtlasEdge> removeUnusedArrayEntries(AtlasAttribute attribute, List<AtlasEdge> currentEntries, List<AtlasEdge> newEntries, AtlasVertex entityVertex) throws AtlasBaseException {
        if (CollectionUtils.isNotEmpty(currentEntries)) {
            ...
            if (AtlasGraphUtilsV2.isReference(entryType)) {
        ...
        if (CollectionUtils.isNotEmpty(classifications)) {
            ...
            for (AtlasClassification c : classifications) {
                ...
                if (propagateTags && taskManagement != null && DEFERRED_ACTION_ENABLED) {
                    ...
                    createAndQueueTask(ClassificationPropagateTaskFactory.CLASSIFICATION_PROPAGATION_ADD, entityVertex, classificationVertex.getIdForDisplay());
                }
    ...
    public void deleteClassification(String entityGuid, String classificationName) throws AtlasBaseException {
        ...
        if (isPropagationEnabled(classificationVertex)) {
            if (taskManagement != null && DEFERRED_ACTION_ENABLED) {
                createAndQueueTask(ClassificationPropagateTaskFactory.CLASSIFICATION_PROPAGATION_DELETE, entityVertex, classificationVertex.getIdForDisplay());
    ...
    public void updateClassifications(EntityMutationContext context, String guid, List<AtlasClassification> classifications) throws AtlasBaseException {
        ...
        for (AtlasClassification classification : classifications) {
            ...
            if (updatedTagPropagation != null && taskManagement != null && DEFERRED_ACTION_ENABLED) {
                String propagationType = updatedTagPropagation ? ClassificationPropagateTaskFactory.CLASSIFICATION_PROPAGATION_ADD : ClassificationPropagateTaskFactory.CLASSIFICATION_PROPAGATION_DELETE;
