...
import org.apache.compactatlas.intg.model.glossary.enums.AtlasTermAssignmentStatus;
import org.apache.compactatlas.intg.model.glossary.relations.AtlasTermAssignmentHeader;
...
import org.apache.compactatlas.intg.model.instance.AtlasEntity.AtlasEntityExtInfo;
...
import org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.PropagateTags;
import org.apache.compactatlas.intg.model.typedef.AtlasRelationshipEndDef;
...
import org.apache.compactatlas.graphdb.api.AtlasElement;
...
import org.apache.compactatlas.intg.type.AtlasBuiltInTypes.AtlasObjectIdType;
...
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_CONFIDENCE;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_CREATED_BY;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_DESCRIPTION;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_EXPRESSION;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_SOURCE;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_STATUS;
import static org.apache.compactatlas.repository.glossary.GlossaryUtils.TERM_ASSIGNMENT_ATTR_STEWARD;
import static org.apache.compactatlas.intg.model.instance.AtlasRelationship.Status.ACTIVE;
import static org.apache.compactatlas.intg.model.instance.AtlasRelationship.Status.DELETED;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_BIGDECIMAL;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_BIGINTEGER;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_BOOLEAN;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_BYTE;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_DATE;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_DOUBLE;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_FLOAT;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_INT;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_LONG;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_SHORT;
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.ATLAS_TYPE_STRING;
import static org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.PropagateTags.NONE;
import static org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.PropagateTags.ONE_TO_TWO;
import static org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.PropagateTags.TWO_TO_ONE;
import static org.apache.compactatlas.common.repository.Constants.CLASSIFICATION_ENTITY_GUID;
import static org.apache.compactatlas.common.repository.Constants.CLASSIFICATION_LABEL;
import static org.apache.compactatlas.common.repository.Constants.CLASSIFICATION_VALIDITY_PERIODS_KEY;
import static org.apache.compactatlas.common.repository.Constants.TERM_ASSIGNMENT_LABEL;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.*;
import static org.apache.compactatlas.repository.repository.store.graph.v2.AtlasGraphUtilsV2.isReference;
import static org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute.AtlasRelationshipEdgeDirection;
import static org.apache.compactatlas.intg.type.AtlasStructType.AtlasAttribute.AtlasRelationshipEdgeDirection.BOTH;
...
public class EntityGraphRetriever {
    ...
    private AtlasObjectId mapVertexToObjectId(AtlasVertex entityVertex, String edgeLabel, AtlasEdge edge,
        ...
        if (GraphHelper.elementExists(edge)) {
            ...
            if (StringUtils.equals(AtlasGraphUtilsV2.getIdFromVertex(referenceVertex), AtlasGraphUtilsV2.getIdFromVertex(entityVertex))) {
