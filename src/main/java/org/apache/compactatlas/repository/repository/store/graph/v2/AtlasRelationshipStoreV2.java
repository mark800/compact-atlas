...
import org.apache.compactatlas.authorize.AtlasRelationshipAccessRequest;
...
import org.apache.compactatlas.intg.model.notification.EntityNotification.EntityNotificationV2.OperationType;
...
import static org.apache.compactatlas.intg.AtlasConfiguration.NOTIFICATION_RELATIONSHIPS_ENABLED;
import static org.apache.compactatlas.intg.model.instance.AtlasEntity.Status.DELETED;
import static org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.PropagateTags.BOTH;
...
import static org.apache.compactatlas.common.repository.Constants.ENTITY_TYPE_PROPERTY_KEY;
import static org.apache.compactatlas.common.repository.Constants.HOME_ID_KEY;
import static org.apache.compactatlas.common.repository.Constants.PROVENANCE_TYPE_KEY;
import static org.apache.compactatlas.common.repository.Constants.RELATIONSHIPTYPE_TAG_PROPAGATION_KEY;
import static org.apache.compactatlas.common.repository.Constants.RELATIONSHIP_GUID_PROPERTY_KEY;
import static org.apache.compactatlas.common.repository.Constants.VERSION_PROPERTY_KEY;
...
public class AtlasRelationshipStoreV2 implements AtlasRelationshipStore {
    ...
    public AtlasEdge createRelationship(AtlasVertex end1Vertex, AtlasVertex end2Vertex, AtlasRelationship relationship, boolean existingRelationshipCheck) throws AtlasBaseException {
        ...
        try {
            ...
            if (existingRelationshipCheck) {
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("Created relationship edge from [{}] --> [{}] using edge label: [{}]", AtlasGraphUtilsV2.getTypeName(end1Vertex), AtlasGraphUtilsV2.getTypeName(end2Vertex), relationshipLabel);
                }
            }
    ...
    private void updateTagPropagations(AtlasEdge relationshipEdge, AtlasRelationship relationship) throws AtlasBaseException {
        if (DEFERRED_ACTION_ENABLED) {
            createAndQueueTask(ClassificationPropagateTaskFactory.CLASSIFICATION_PROPAGATION_RELATIONSHIP_UPDATE, relationshipEdge, relationship);
        } else {
    ...
    private boolean vertexHasRelationshipWithType(AtlasVertex vertex, String relationshipTypeName) {
        String relationshipEdgeLabel = getRelationshipEdgeLabel(AtlasGraphUtilsV2.getTypeName(vertex), relationshipTypeName);
