...
import org.apache.compactatlas.repository.repository.store.graph.AtlasDefStore;
import org.apache.compactatlas.repository.repository.store.graph.AtlasTypeDefGraphStore;
import org.apache.compactatlas.intg.type.AtlasType;
import org.apache.compactatlas.intg.type.AtlasTypeRegistry;
import org.apache.compactatlas.intg.typesystem.types.BaseDataTypes.TypeCategory;
...
import static org.apache.compactatlas.common.repository.Constants.TYPE_CATEGORY_PROPERTY_KEY;
import static org.apache.compactatlas.common.repository.Constants.VERTEX_TYPE_PROPERTY_KEY;
...
public class AtlasTypeDefGraphStoreV2 extends AtlasTypeDefGraphStore {
    ...
    protected AtlasDefStore<AtlasBusinessMetadataDef> getBusinessMetadataDefStore(AtlasTypeRegistry typeRegistry) {
        return new org.apache.compactatlas.repository.repository.store.graph.v2.AtlasBusinessMetadataDefStoreV2(this, typeRegistry, this.entityDiscoveryService);
    }
    ...
    public AtlasVertex findTypeVertexByName(String typeName) {
        Iterator results = atlasGraph.query().has(VERTEX_TYPE_PROPERTY_KEY, AtlasGraphUtilsV2.VERTEX_TYPE)
    ...
    AtlasVertex findTypeVertexByGuid(String typeGuid) {
        Iterator<AtlasVertex> vertices = atlasGraph.query().has(VERTEX_TYPE_PROPERTY_KEY, AtlasGraphUtilsV2.VERTEX_TYPE)
    ...
    Iterator<AtlasVertex> findTypeVerticesByCategory(TypeCategory category) {
        ...
        return (Iterator<AtlasVertex>) atlasGraph.query().has(VERTEX_TYPE_PROPERTY_KEY, AtlasGraphUtilsV2.VERTEX_TYPE)
                .has(TYPE_CATEGORY_PROPERTY_KEY, category)
                .vertices().iterator();
    }
    ...
    AtlasVertex createTypeVertex(AtlasBaseTypeDef typeDef) {
        ...
        ret.setProperty(VERTEX_TYPE_PROPERTY_KEY, AtlasGraphUtilsV2.VERTEX_TYPE); // Mark as type vertex
    ...
    boolean isTypeVertex(AtlasVertex vertex) {
        ...
        return AtlasGraphUtilsV2.VERTEX_TYPE.equals(vertexType);
    }
