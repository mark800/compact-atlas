 ...
 */
package org.apache.compactatlas.repository.repository.store.bootstrap;
...
import org.apache.compactatlas.authorize.AtlasAuthorizerFactory;
...
import org.apache.compactatlas.intg.model.patches.AtlasPatch.PatchStatus;
...
import org.apache.compactatlas.repository.repository.patches.AddMandatoryAttributesPatch;
import org.apache.compactatlas.repository.repository.patches.SuperTypesUpdatePatch;
...
import static org.apache.compactatlas.intg.model.patches.AtlasPatch.PatchStatus.APPLIED;
import static org.apache.compactatlas.intg.model.patches.AtlasPatch.PatchStatus.FAILED;
import static org.apache.compactatlas.intg.model.patches.AtlasPatch.PatchStatus.SKIPPED;
import static org.apache.compactatlas.intg.model.patches.AtlasPatch.PatchStatus.UNKNOWN;
...
public class AtlasTypeDefStoreInitializer implements ActiveStateChangeHandler {
    ...
    private void loadBootstrapTypeDefs() {
        ...
        String modelsDirName = conf.getString("init.models.path");
