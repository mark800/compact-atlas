...
import org.apache.compactatlas.intg.model.instance.AtlasEntity.Status;
import org.apache.compactatlas.intg.model.instance.AtlasEntityHeader;
import org.apache.compactatlas.intg.model.instance.AtlasEntityHeaders;
...
import org.apache.compactatlas.repository.repository.store.graph.EntityGraphDiscovery;
...
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.PURGE;
import static org.apache.compactatlas.intg.model.instance.EntityMutations.EntityOperation.UPDATE;
import static org.apache.compactatlas.common.repository.Constants.IS_INCOMPLETE_PROPERTY_KEY;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.getTypeName;
import static org.apache.compactatlas.repository.repository.graph.GraphHelper.isEntityIncomplete;
...
public class AtlasEntityStoreV2 implements AtlasEntityStore {
    ...
    public void setLabels(String guid, Set<String> labels) throws AtlasBaseException {
        ...
        if (addedLabels != null) {
            AtlasEntityAccessRequest.AtlasEntityAccessRequestBuilder requestBuilder = new AtlasEntityAccessRequest.AtlasEntityAccessRequestBuilder(typeRegistry, AtlasPrivilege.ENTITY_ADD_LABEL, entityHeader);
        ...
        if (removedLabels != null) {
            AtlasEntityAccessRequest.AtlasEntityAccessRequestBuilder requestBuilder = new AtlasEntityAccessRequest.AtlasEntityAccessRequestBuilder(typeRegistry, AtlasPrivilege.ENTITY_REMOVE_LABEL, entityHeader);
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(context.getUpdatedEntities())) {
                ...
                for (AtlasEntity entity : context.getUpdatedEntities()) {
                    ...
                    AtlasEntityComparator.AtlasEntityDiffResult diffResult   = entityComparator.getDiffResult(entity, storedVertex, !storeDifferentialAudits);
