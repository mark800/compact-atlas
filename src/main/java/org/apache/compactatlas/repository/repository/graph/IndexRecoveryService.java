...
import org.apache.compactatlas.common.service.Service;
...
import static org.apache.compactatlas.intg.ApplicationProperties.DEFAULT_INDEX_RECOVERY;
import static org.apache.compactatlas.common.repository.Constants.PROPERTY_KEY_INDEX_RECOVERY_NAME;
import static org.apache.compactatlas.common.repository.Constants.PROPERTY_KEY_INDEX_RECOVERY_PREV_TIME;
import static org.apache.compactatlas.common.repository.Constants.PROPERTY_KEY_INDEX_RECOVERY_START_TIME;
    ...
    static class RecoveryInfoManagement {
        ...
        public void updateStartTime(Long startTime) {
            try {
                ...
                AtlasGraphUtilsV2.setEncodedProperty(vertex, PROPERTY_KEY_INDEX_RECOVERY_NAME, INDEX_RECOVERY_TYPE_NAME);
                AtlasGraphUtilsV2.setEncodedProperty(vertex, PROPERTY_KEY_INDEX_RECOVERY_START_TIME, startTime);
                AtlasGraphUtilsV2.setEncodedProperty(vertex, PROPERTY_KEY_INDEX_RECOVERY_PREV_TIME, prevStartTime);
