...
import org.apache.compactatlas.intg.typesystem.types.BaseDataTypes;
...
import static org.apache.compactatlas.intg.model.typedef.AtlasBusinessMetadataDef.ATTR_OPTION_APPLICABLE_ENTITY_TYPES;
...
public class AtlasBusinessMetadataDefStoreV2 extends AtlasAbstractDefStoreV2<AtlasBusinessMetadataDef> {
    ...
    public AtlasVertex preCreate(AtlasBusinessMetadataDef businessMetadataDef) throws AtlasBaseException {
        ...
        if (type.getTypeCategory() != TypeCategory.BUSINESS_METADATA) {
            throw new AtlasBaseException(AtlasErrorCode.TYPE_MATCH_FAILED, businessMetadataDef.getName(),
                    BaseDataTypes.TypeCategory.BUSINESS_METADATA.name());
        }
    ...
    public List<AtlasBusinessMetadataDef> getAll() throws AtlasBaseException {
        ...
        Iterator<AtlasVertex> vertices = typeDefStore.findTypeVerticesByCategory(BaseDataTypes.TypeCategory.BUSINESS_METADATA);
    ...
    public AtlasBusinessMetadataDef getByName(String name) throws AtlasBaseException {
        ...
        AtlasVertex vertex = typeDefStore.findTypeVertexByNameAndCategory(name, BaseDataTypes.TypeCategory.BUSINESS_METADATA);
    ...
    public AtlasBusinessMetadataDef getByGuid(String guid) throws AtlasBaseException {
        ...
        AtlasVertex vertex = typeDefStore.findTypeVertexByGuidAndCategory(guid, BaseDataTypes.TypeCategory.BUSINESS_METADATA);
    ...
    public AtlasBusinessMetadataDef updateByName(String name, AtlasBusinessMetadataDef typeDef) throws AtlasBaseException {
        ...
        if (type.getTypeCategory() != TypeCategory.BUSINESS_METADATA) {
            throw new AtlasBaseException(AtlasErrorCode.TYPE_MATCH_FAILED, typeDef.getName(), BaseDataTypes.TypeCategory.BUSINESS_METADATA.name());
        }
    ...
    public AtlasVertex preDeleteByName(String name) throws AtlasBaseException {
        ...
        AtlasVertex ret = typeDefStore.findTypeVertexByNameAndCategory(name, BaseDataTypes.TypeCategory.BUSINESS_METADATA);
    ...
    public AtlasVertex preDeleteByGuid(String guid) throws AtlasBaseException {
        ...
        AtlasVertex ret = typeDefStore.findTypeVertexByGuidAndCategory(guid, BaseDataTypes.TypeCategory.BUSINESS_METADATA);
    ...
    private AtlasBusinessMetadataDef toBusinessMetadataDef(AtlasVertex vertex) throws AtlasBaseException {
        ...
        if (vertex != null && typeDefStore.isTypeVertex(vertex, BaseDataTypes.TypeCategory.BUSINESS_METADATA)) {
