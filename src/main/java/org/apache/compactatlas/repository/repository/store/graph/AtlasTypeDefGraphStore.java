 ...
 */
package org.apache.compactatlas.repository.repository.store.graph;
...
import org.apache.compactatlas.authorize.AtlasTypeAccessRequest;
import org.apache.compactatlas.authorize.AtlasTypesDefFilterRequest;
import org.apache.compactatlas.intg.exception.AtlasBaseException;
import org.apache.compactatlas.repository.listener.ChangedTypeDefs;
import org.apache.compactatlas.repository.listener.TypeDefChangeListener;
...
import org.apache.compactatlas.intg.model.typedef.AtlasStructDef.AtlasConstraintDef;
...
import org.apache.compactatlas.intg.type.AtlasTypeRegistry.AtlasTransientTypeRegistry;
import org.apache.compactatlas.repository.util.AtlasRepositoryConfiguration;
...
import static org.apache.compactatlas.intg.model.discovery.SearchParameters.ALL_ENTITY_TYPES;
import static org.apache.compactatlas.intg.model.discovery.SearchParameters.ALL_CLASSIFICATION_TYPES;
...
public abstract class AtlasTypeDefGraphStore implements AtlasTypeDefStore {
    ...
    public void init() throws AtlasBaseException {
        ...
        try {
            ...
            AtlasDefStore entityDefStoreV2 = getEnumDefStore(ttr);
            List<AtlasEnumDef> enumDefs = entityDefStoreV2.getAll();
            AtlasTypesDef typesDef = new AtlasTypesDef(enumDefs,
    ...
    public AtlasTypesDef createUpdateTypesDef(AtlasTypesDef typesDef) throws AtlasBaseException {
        ...
        AtlasTypesDef typesToUpdate = AtlasTypeDefStoreInitializer.getTypesToUpdate(typesDef, typeRegistry, false);
    ...
    private AtlasTypesDef addToGraphStore(AtlasTypesDef typesDef, AtlasTransientTypeRegistry ttr) throws AtlasBaseException {
        ...
        Map<AtlasVertex, AtlasClassificationDef> preCreateClassifiDefs = new HashMap<>();
        ...
        if (CollectionUtils.isNotEmpty(typesDef.getClassificationDefs())) {
            for (AtlasClassificationDef classifiDef : typesDef.getClassificationDefs()) {
                try {
                    preCreateClassifiDefs.put(classifiDefStore.preCreate(classifiDef), classifiDef);
                } catch (AtlasBaseException e) {
        ...
        if (CollectionUtils.isNotEmpty(typesDef.getClassificationDefs())) {
            for (AtlasVertex classifiPreDef : preCreateClassifiDefs.keySet()) {
                AtlasClassificationDef createdDef = classifiDefStore.create(preCreateClassifiDefs.get(classifiPreDef), classifiPreDef);
                ttr.updateGuid(createdDef.getName(), createdDef.getGuid());
