 ...
 */
package org.apache.compactatlas.repository.tasks;
...
import static org.apache.compactatlas.common.repository.Constants.TASK_GUID;
...
public class TaskRegistry {
    ...
    private AtlasVertex createVertex(AtlasTask task) {
        ...
        AtlasGraphUtilsV2.setEncodedProperty(ret, Constants.TASK_TYPE_PROPERTY_KEY, Constants.TASK_TYPE_NAME);
        ...
        AtlasGraphUtilsV2.setEncodedProperty(ret, Constants.TASK_PARAMETERS, AtlasJson.toJson(task.getParameters()));
