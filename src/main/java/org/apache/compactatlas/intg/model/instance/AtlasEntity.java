 ...
 */
package org.apache.compactatlas.intg.model.instance;
...
import org.apache.compactatlas.intg.model.PList;
import org.apache.compactatlas.intg.model.SearchFilter.SortType;
...
public class AtlasEntity extends AtlasStruct implements Serializable {
    ...
    public AtlasEntity(org.apache.compactatlas.intg.model.instance.AtlasEntity other) {
        super(other);
    ...
    public boolean equals(Object o) {
        ...
        org.apache.compactatlas.intg.model.instance.AtlasEntity that = (org.apache.compactatlas.intg.model.instance.AtlasEntity) o;
    ...
    public static class AtlasEntityExtInfo implements Serializable {
        ...
        private Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> referredEntities;
        ...
        public AtlasEntityExtInfo(org.apache.compactatlas.intg.model.instance.AtlasEntity referredEntity) {
            addReferredEntity(referredEntity);
        }

        public AtlasEntityExtInfo(Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> referredEntities) {
        ...
        public Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> getReferredEntities() { return referredEntities; }

        public void setReferredEntities(Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> referredEntities) { this.referredEntities = referredEntities; }

        @JsonIgnore
        public final void addReferredEntity(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) {
            addReferredEntity(entity.getGuid(), entity);
        }

        @JsonIgnore
        public final void addReferredEntity(String guid, org.apache.compactatlas.intg.model.instance.AtlasEntity entity) {
            Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> r = this.referredEntities;
        ...
        @JsonIgnore
        public final org.apache.compactatlas.intg.model.instance.AtlasEntity removeReferredEntity(String guid) {
            Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> r = this.referredEntities;
        ...
        @JsonIgnore
        public final org.apache.compactatlas.intg.model.instance.AtlasEntity getReferredEntity(String guid) {
            Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> r = this.referredEntities;
        ...
        @JsonIgnore
        public org.apache.compactatlas.intg.model.instance.AtlasEntity getEntity(String guid) {
            return getReferredEntity(guid);
        }

        @JsonIgnore
        public org.apache.compactatlas.intg.model.instance.AtlasEntity removeEntity(String guid) {
            Map<String, org.apache.compactatlas.intg.model.instance.AtlasEntity> r = this.referredEntities;
        ...
        public void updateEntityGuid(String oldGuid, String newGuid) {
            org.apache.compactatlas.intg.model.instance.AtlasEntity entity = getEntity(oldGuid);
    ...
    public static class AtlasEntityWithExtInfo extends AtlasEntityExtInfo {
        ...
        private org.apache.compactatlas.intg.model.instance.AtlasEntity entity;

        public AtlasEntityWithExtInfo() {
            this(null, null);
        }

        public AtlasEntityWithExtInfo(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) {
            this(entity, null);
        }

        public AtlasEntityWithExtInfo(org.apache.compactatlas.intg.model.instance.AtlasEntity entity, AtlasEntityExtInfo extInfo) {
            super(extInfo);
        ...
        public void setEntity(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) { this.entity = entity; }

        @JsonIgnore
        @Override
        public org.apache.compactatlas.intg.model.instance.AtlasEntity getEntity(String guid) {
            org.apache.compactatlas.intg.model.instance.AtlasEntity ret = super.getEntity(guid);
    ...
    public static class AtlasEntitiesWithExtInfo extends AtlasEntityExtInfo {
        ...
        private List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities;

        public AtlasEntitiesWithExtInfo() {
            this(null, null);
        }

        public AtlasEntitiesWithExtInfo(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) { this(Arrays.asList(entity), null);
        }

        public AtlasEntitiesWithExtInfo(List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities) {
            this(entities, null);
        }
        ...
        public AtlasEntitiesWithExtInfo(List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities, AtlasEntityExtInfo extInfo) {
            super(extInfo);

            this.entities = entities;
        }

        public List<org.apache.compactatlas.intg.model.instance.AtlasEntity> getEntities() { return entities; }

        public void setEntities(List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities) { this.entities = entities; }
        ...
        public org.apache.compactatlas.intg.model.instance.AtlasEntity getEntity(String guid) {
            ...
            if (ret == null && CollectionUtils.isNotEmpty(entities)) {
                for (org.apache.compactatlas.intg.model.instance.AtlasEntity entity : entities) {
                    if (StringUtils.equals(guid, entity.getGuid())) {
                        ret = entity;
        ...
        public void addEntity(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) {
            List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities = this.entities;
        ...
        public void removeEntity(org.apache.compactatlas.intg.model.instance.AtlasEntity entity) {
            List<org.apache.compactatlas.intg.model.instance.AtlasEntity> entities = this.entities;
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.PROPERTY)
    @XmlSeeAlso(org.apache.compactatlas.intg.model.instance.AtlasEntity.class)
    public static class AtlasEntities extends PList<org.apache.compactatlas.intg.model.instance.AtlasEntity> {
        private static final long serialVersionUID = 1L;
        ...
        public AtlasEntities(List<org.apache.compactatlas.intg.model.instance.AtlasEntity> list) {
            super(list);
        }
