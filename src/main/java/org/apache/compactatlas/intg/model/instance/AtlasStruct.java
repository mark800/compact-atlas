...
public class AtlasStruct implements Serializable {
    ...
    public AtlasStruct(org.apache.compactatlas.intg.model.instance.AtlasStruct other) {
        if (other != null) {
    ...
    public boolean equals(Object o) {
        ...
        org.apache.compactatlas.intg.model.instance.AtlasStruct that = (org.apache.compactatlas.intg.model.instance.AtlasStruct) o;
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.PROPERTY)
    @XmlSeeAlso(org.apache.compactatlas.intg.model.instance.AtlasStruct.class)
    public static class AtlasStructs extends PList<org.apache.compactatlas.intg.model.instance.AtlasStruct> {
        private static final long serialVersionUID = 1L;
        ...
        public AtlasStructs(List<org.apache.compactatlas.intg.model.instance.AtlasStruct> list) {
            super(list);
        }
    ...
    public static StringBuilder dumpModelObjects(Collection<? extends org.apache.compactatlas.intg.model.instance.AtlasStruct> objList, StringBuilder sb) {
        if (sb == null) {
            sb = new StringBuilder();
        }
        ...
        if (CollectionUtils.isNotEmpty(objList)) {
            int i = 0;
            for (org.apache.compactatlas.intg.model.instance.AtlasStruct obj : objList) {
                if (i > 0) {
                    sb.append(", ");
                }
