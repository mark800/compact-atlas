...
package org.apache.compactatlas.intg.model.tasks;
...
public class AtlasTask {
    ...
    public void updateStatusFromAttemptCount() {
        setStatus((attemptCount < MAX_ATTEMPT_COUNT) ? org.apache.compactatlas.intg.model.tasks.AtlasTask.Status.PENDING : org.apache.compactatlas.intg.model.tasks.AtlasTask.Status.FAILED);
    }
}