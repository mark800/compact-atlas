 ...
 */
package org.apache.compactatlas.intg.model.impexp;
...
public class AtlasExportRequest implements Serializable {
    ...
    public boolean getSkipLineageOptionValue() {
        if (MapUtils.isEmpty(getOptions()) ||
                !getOptions().containsKey(org.apache.compactatlas.intg.model.impexp.AtlasExportRequest.OPTION_SKIP_LINEAGE)) {
            return false;
        }

        Object o = getOptions().get(org.apache.compactatlas.intg.model.impexp.AtlasExportRequest.OPTION_SKIP_LINEAGE);
        if (o instanceof String) {
    ...
    public long getChangeTokenFromOptions() {
        if (MapUtils.isEmpty(getOptions()) ||
                ...
                !getOptions().containsKey(org.apache.compactatlas.intg.model.impexp.AtlasExportRequest.FETCH_TYPE_INCREMENTAL_CHANGE_MARKER)) {
            return 0L;
        }

        return Long.parseLong(getOptions().get(org.apache.compactatlas.intg.model.impexp.AtlasExportRequest.FETCH_TYPE_INCREMENTAL_CHANGE_MARKER).toString());
    }
