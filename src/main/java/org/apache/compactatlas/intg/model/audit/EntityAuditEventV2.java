 ...
 */
package org.apache.compactatlas.intg.model.audit;

import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import org.apache.compactatlas.intg.model.Clearable;
...
import static org.apache.compactatlas.intg.model.audit.EntityAuditEventV2.EntityAuditType.ENTITY_AUDIT_V2;
...
public class EntityAuditEventV2 implements Serializable, Clearable {
    ...
    public boolean equals(Object o) {
        ...
        org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 that = (org.apache.compactatlas.intg.model.audit.EntityAuditEventV2) o;
    ...
    public static class UserComparator implements Comparator<org.apache.compactatlas.intg.model.audit.EntityAuditEventV2> {
        @Override
        public int compare(org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 me, org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 other) {
    ...
    public static class ActionComparator implements Comparator<org.apache.compactatlas.intg.model.audit.EntityAuditEventV2> {
        @Override
        public int compare(org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 me, org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 other) {
    ...
    public static class TimestampComparator implements Comparator<org.apache.compactatlas.intg.model.audit.EntityAuditEventV2> {
        @Override
        public int compare(org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 me, org.apache.compactatlas.intg.model.audit.EntityAuditEventV2 other) {
    ...
    public static void sortEvents(List<org.apache.compactatlas.intg.model.audit.EntityAuditEventV2> events, String sortByColumn, boolean sortOrderDesc) {
        final Comparator<org.apache.compactatlas.intg.model.audit.EntityAuditEventV2> comparator;

        switch (sortByColumn.toLowerCase()) {
            case SORT_COLUMN_USER:
                comparator = new org.apache.compactatlas.intg.model.audit.EntityAuditEventV2.UserComparator();
                break;

            case SORT_COLUMN_ACTION:
                comparator = new org.apache.compactatlas.intg.model.audit.EntityAuditEventV2.ActionComparator();
                break;

            case SORT_COLUMN_TIMESTAMP:
            default:
                comparator = new org.apache.compactatlas.intg.model.audit.EntityAuditEventV2.TimestampComparator();
                break;
        }
