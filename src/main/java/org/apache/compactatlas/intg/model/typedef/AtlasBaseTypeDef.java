...
public abstract class AtlasBaseTypeDef implements java.io.Serializable {
    ...
    public static final String SERIALIZED_DATE_FORMAT_STR2 = "yyyy-MM-dd'T'HH:mm:ss.SSS";
    ...
    public static DateFormat getDateFormatter2() {
        return THREAD_LOCAL_DATE_FORMAT2.get();
    }
    ...
    private static final ThreadLocal<DateFormat> THREAD_LOCAL_DATE_FORMAT2 = new ThreadLocal<DateFormat>() {
        @Override
        public DateFormat initialValue() {
            DateFormat ret = new SimpleDateFormat(SERIALIZED_DATE_FORMAT_STR2);
    ...
    protected AtlasBaseTypeDef(org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef other) {
        if (other != null) {
    ...
    public boolean equals(Object o) {
        ...
        org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef that = (org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef) o;
