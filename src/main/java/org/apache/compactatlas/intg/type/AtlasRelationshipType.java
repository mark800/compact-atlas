...
public class AtlasRelationshipType extends AtlasStructType {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.type.AtlasRelationshipType.class);
    ...
    public static void validateAtlasRelationshipDef(AtlasRelationshipDef relationshipDef) throws AtlasBaseException {
        ...
        if ((endDef1.getCardinality() == Cardinality.LIST) ||
                (endDef2.getCardinality() == Cardinality.LIST)) {
