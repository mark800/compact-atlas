...
public abstract class AtlasType {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.type.AtlasType.class);
     ...
     */
    public org.apache.compactatlas.intg.type.AtlasType getTypeForAttribute() {
        return this;
    }
