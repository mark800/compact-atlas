...
public class AtlasMapType extends AtlasType {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.type.AtlasMapType.class);
    ...
    public AtlasType getTypeForAttribute() {
        ...
        if (keyAttributeType == keyType && valueAttributeType == valueType) {
            ...
            AtlasType attributeType = new org.apache.compactatlas.intg.type.AtlasMapType(keyAttributeType, valueAttributeType);
