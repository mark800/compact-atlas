...
public class AtlasClassificationType extends AtlasStructType {
    ...
    public  static final org.apache.compactatlas.intg.type.AtlasClassificationType CLASSIFICATION_ROOT      = initRootClassificationType();
    ...
    private List<org.apache.compactatlas.intg.type.AtlasClassificationType> superTypes               = Collections.emptyList();
    ...
    public static org.apache.compactatlas.intg.type.AtlasClassificationType getClassificationRoot() {return CLASSIFICATION_ROOT; }

    @Override
    void resolveReferences(AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        super.resolveReferences(typeRegistry);

        List<org.apache.compactatlas.intg.type.AtlasClassificationType> s    = new ArrayList<>();
        ...
        for (String superTypeName : classificationDef.getSuperTypes()) {
            ...
            if (superType instanceof org.apache.compactatlas.intg.type.AtlasClassificationType) {
                s.add((org.apache.compactatlas.intg.type.AtlasClassificationType)superType);
            } else {
    ...
    void resolveReferencesPhase2(AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        ...
        for (org.apache.compactatlas.intg.type.AtlasClassificationType superType : superTypes) {
            superType.addSubType(this);
        }

        for (String superTypeName : allSuperTypes) {
            org.apache.compactatlas.intg.type.AtlasClassificationType superType = typeRegistry.getClassificationTypeByName(superTypeName);
    ...
    public AtlasAttribute getSystemAttribute(String attributeName) {
        return org.apache.compactatlas.intg.type.AtlasClassificationType.CLASSIFICATION_ROOT.allAttributes.get(attributeName);
    }

    private void addSubType(org.apache.compactatlas.intg.type.AtlasClassificationType subType) {
        subTypes.add(subType.getTypeName());
    }

    private void addToAllSubTypes(org.apache.compactatlas.intg.type.AtlasClassificationType subType) {
    ...
    public boolean isSuperTypeOf(org.apache.compactatlas.intg.type.AtlasClassificationType classificationType) {
    ...
    public boolean isSubTypeOf(org.apache.compactatlas.intg.type.AtlasClassificationType classificationType) {
    ...
    private static org.apache.compactatlas.intg.type.AtlasClassificationType initRootClassificationType() {
        ...
        return new org.apache.compactatlas.intg.type.AtlasClassificationType(classificationDef);
    }
