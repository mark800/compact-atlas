...
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.SERVICE_TYPE_ATLAS_CORE;
import static org.apache.compactatlas.intg.model.typedef.AtlasStructDef.AtlasAttributeDef.COUNT_NOT_SET;

/**
 * class that implements behaviour of an array-type.
 */
public class AtlasArrayType extends AtlasType {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.type.AtlasArrayType.class);
    ...
    public AtlasType getTypeForAttribute() {
        ...
        if (elementAttributeType == elementType) {
            ...
            AtlasType attributeType = new org.apache.compactatlas.intg.type.AtlasArrayType(elementAttributeType, minCount, maxCount, cardinality);
