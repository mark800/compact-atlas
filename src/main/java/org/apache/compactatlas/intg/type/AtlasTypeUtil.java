...
import org.apache.compactatlas.intg.model.typedef.AtlasRelationshipDef.RelationshipCategory;
...
public class AtlasTypeUtil {
    ...
    public static AtlasAttributeDef createOptionalAttrDefWithConstraint(String name, String typeName, String type, Map param) {
        AtlasAttributeDef ret = org.apache.compactatlas.intg.type.AtlasTypeUtil.createOptionalAttrDef(name, typeName);
        ret.addConstraint(new AtlasConstraintDef(type, param));
    ...
    public static Collection<AtlasObjectId> toObjectIds(Collection<AtlasEntity> entities) {
        ...
        if (CollectionUtils.isNotEmpty(entities)) {
            for (AtlasEntity entity : entities) {
                if (entity != null) {
                    ret.add(org.apache.compactatlas.intg.type.AtlasTypeUtil.getAtlasObjectId(entity));
                }
            }
        }
    ...
    public static AttributeDefinition toV1AttributeDefinition(AtlasAttribute attribute) {
        ...
        if (entity != null) {
            ...
            if (CollectionUtils.isNotEmpty(entity.getClassifications())) {
                Map<String, HashMap> traitDetails = entity.getClassifications()
                                                          .stream()
                                                          .collect(Collectors.toMap(AtlasStruct::getTypeName, org.apache.compactatlas.intg.type.AtlasTypeUtil::getNestedTraitDetails));
