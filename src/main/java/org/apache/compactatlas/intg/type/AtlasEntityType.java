 ...
 */
package org.apache.compactatlas.intg.type;
...
import static org.apache.compactatlas.intg.model.typedef.AtlasBaseTypeDef.*;
import static org.apache.compactatlas.intg.type.Constants.*;
...
public class AtlasEntityType extends AtlasStructType {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.type.AtlasEntityType.class);

    public  static final org.apache.compactatlas.intg.type.AtlasEntityType ENTITY_ROOT         = new AtlasRootEntityType();
    ...
    private List<org.apache.compactatlas.intg.type.AtlasEntityType>                            superTypes                 = Collections.emptyList();
    ...
    public static org.apache.compactatlas.intg.type.AtlasEntityType getEntityRoot() {return ENTITY_ROOT; }

    @Override
    void resolveReferences(AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        super.resolveReferences(typeRegistry);

        List<org.apache.compactatlas.intg.type.AtlasEntityType>       s    = new ArrayList<>();
        ...
        for (String superTypeName : entityDef.getSuperTypes()) {
            ...
            if (superType instanceof org.apache.compactatlas.intg.type.AtlasEntityType) {
                s.add((org.apache.compactatlas.intg.type.AtlasEntityType) superType);
            } else {
        ...
        if (this.displayTextAttribute == null) { // find displayTextAttribute in direct superTypes
            for (org.apache.compactatlas.intg.type.AtlasEntityType superType : superTypes) {
    ...
    void resolveReferencesPhase2(AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        ...
        for (String superTypeName : allSuperTypes) {
            org.apache.compactatlas.intg.type.AtlasEntityType superType = typeRegistry.getEntityTypeByName(superTypeName);
    ...
    void resolveReferencesPhase3(AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        for (AtlasAttributeDef attributeDef : getStructDef().getAttributeDefs()) {
            ...
            org.apache.compactatlas.intg.type.AtlasEntityType attributeEntityType = getReferencedEntityType(attributeType);
    ...
    public AtlasAttribute getSystemAttribute(String attributeName) {
        return org.apache.compactatlas.intg.type.AtlasEntityType.ENTITY_ROOT.allAttributes.get(attributeName);
    }
    ...
    public AtlasBusinessAttribute getBusinesAAttribute(String bmAttrQualifiedName) {
        ...
        if (bmAttrQualifiedName != null) {
            int idxSep = bmAttrQualifiedName.indexOf(org.apache.compactatlas.intg.type.AtlasEntityType.NS_ATTRIBUTE_NAME_SEPARATOR);
    ...
    public boolean isSuperTypeOf(org.apache.compactatlas.intg.type.AtlasEntityType entityType) {
    ...
    public boolean isSubTypeOf(org.apache.compactatlas.intg.type.AtlasEntityType entityType) {
    ...
    private void addSubType(org.apache.compactatlas.intg.type.AtlasEntityType subType) {
        subTypes.add(subType.getTypeName());
    }

    private void addToAllSubTypes(org.apache.compactatlas.intg.type.AtlasEntityType subType) {
    ...
    static public Set<String> getEntityTypesAndAllSubTypes(Set<String> entityTypes, AtlasTypeRegistry typeRegistry) throws AtlasBaseException {
        ...
        for (String typeName : entityTypes) {
            org.apache.compactatlas.intg.type.AtlasEntityType entityType = typeRegistry.getEntityTypeByName(typeName);
            if (entityType == null) {
    ...
    private boolean isValidRelationshipType(AtlasType attributeType) {
        ...
        if (attributeType != null) {
            ...
            if (attributeType instanceof AtlasObjectIdType || attributeType instanceof org.apache.compactatlas.intg.type.AtlasEntityType) {
                ret = true;
            }
        }
     ...
     */
    private static class AtlasRootEntityType extends org.apache.compactatlas.intg.type.AtlasEntityType {
