...
public class Id implements Serializable {
    ...
    public static final String JSON_CLASS_ID = "org.apache.atlas.atlas_intg.typesystem.json.InstanceSerialization$_Id";
    ...
    public Id(org.apache.compactatlas.intg.v1.model.instance.Id that) {
        if (that != null) {
            this.id       = that.id;
