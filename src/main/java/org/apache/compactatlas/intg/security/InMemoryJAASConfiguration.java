...
package org.apache.compactatlas.intg.security;
...
public final class InMemoryJAASConfiguration extends Configuration {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.compactatlas.intg.security.InMemoryJAASConfiguration.class);
    ...
    public static void init(Properties properties) throws AtlasException {
        ...
        if (properties != null && MapUtils.isNotEmpty(properties)) {
            org.apache.compactatlas.intg.security.InMemoryJAASConfiguration conf = new org.apache.compactatlas.intg.security.InMemoryJAASConfiguration(properties);
