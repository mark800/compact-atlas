...
import org.apache.compactatlas.graphdb.api.AggregationContext;
...
import static org.apache.compactatlas.common.repository.Constants.FREETEXT_REQUEST_HANDLER;
import static org.apache.compactatlas.common.repository.Constants.VERTEX_INDEX;
...
public class AtlasJanusGraphIndexClient implements AtlasGraphIndexClient {
    ...
    public void applySearchWeight(String collectionName, Map<String, Integer> indexFieldName2SearchWeightMap) {
        if(!"solr".equals(configuration.getString(ApplicationProperties.INDEX_BACKEND_CONF))){
            return ;
        }
